...
const Login = () => {
    ...
    if (loading || loading_email) {
        return <img className='mx-auto' src={loadingPic} alt="" />
    }
    if (user || user_email) {
        navigate('/');
    }

    const SignFrom = (event) => {
    ...
    return (
        <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
                ...
                <form onSubmit={SignFrom} className="mt-6">
                    <div className="mb-2">
                    ...
                    <div className="mb-2">
                        ...
                        <input ref={passwordRef} type="password" className="block w-full px-4 py-2 mt-2 text-sky-700 bg-white border rounded-md focus:border-sky-400 focus:ring-sky-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
                    <a href="#" className="text-xs text-sky-600 hover:underline">
                        Forget Password?
                    </a>
                    <div className="mt-6">
                        <input className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-sky-700 rounded-md hover:bg-sky-600 focus:outline-none focus:bg-sky-600" type="submit" value="Log In" />
                    </div>
                </form>
                ...
                <p className="mt-8 text-xs font-light text-center text-gray-700">
                    ...
                    <Link to="/signUp"><a href="#" className="font-medium text-sky-600 hover:underline">
                        Sign up
                    </a></Link>
                </p>
            </div>
